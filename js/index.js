...
const textContent1 = document.createTextNode('Careers');
a1.appendChild(textContent1);
const a2 = document.createElement('a');
const textContent2 = document.createTextNode('Locations');
a2.appendChild(textContent2);

const newAnchor1 = nav.appendChild(a1);
const newAnchor2 = nav.appendChild(a2);
...
const mainHeadings = main.querySelectorAll('h4');
...
// FOOTER CONTENT
const footer = document.querySelector('footer').querySelector('p');
